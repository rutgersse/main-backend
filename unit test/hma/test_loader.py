...
class TestCompletions(unittest.TestCase):
    ...
    def test_completionExact(self):
        ...
        """
        c = set(loader.getCompletions('hma').split('\n'))
        self.assertIn('hma', c)
        self.assertIn('hma.test', c)
        self.assertIn('hma.test.test_loader', c)
        self.assertIn('hma.test.test_loader.TestCompletions', c)
        self.assertIn(
                'hma.test.test_loader.TestCompletions.test_completionExact', c)
    ...
    def test_completionPartialShort(self):
        ...
        """
        cwd = os.getcwd()
        hma_parent = dirname(dirname(dirname(os.path.abspath(__file__))))
        os.chdir(hma_parent)
        ...
        self.assertIn('hma.test.test_loader.TestCompletions', c)
        self.assertIn(
            'hma.test.test_loader.TestCompletions.test_completionPartialShort', c)
    ...
    def test_completionPartial(self):
        ...
        """
        c = set(loader.getCompletions(['hma.te', 'hma']).split('\n'))
        self.assertIn('hma.test', c)
        self.assertIn('hma.test.test_loader', c)
        self.assertIn('hma.test.test_loader.TestCompletions', c)
        self.assertIn(
            'hma.test.test_loader.TestCompletions.test_completionPartial', c)
        self.assertNotIn('hma', c)
