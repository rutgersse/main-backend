...
from hma.output import Colors, hmaStream
from hma.result import hmaTestResult, proto_test, \
...
class TesthmaTestResult(unittest.TestCase):
    ...
    @patch('hma.result.hmaTestResult.printErrors')
...
class TesthmaTestResultAdds(unittest.TestCase):
