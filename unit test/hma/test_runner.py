...
from hma.exceptions import InitializerOrFinalizerError
from hma.loader import loadTargets
from hma.output import hmaStream
from hma.runner import InitializerOrFinalizer, run
...
class TestInitializerOrFinalizer(unittest.TestCase):
    ...
    def test_importable(self):
        ...
        global importable_function_worked
        importable_function_worked = False
        InitializerOrFinalizer('hma.test.test_runner._importableFunction')()
    ...
    def test_not_callable(self):
        ...
        """
        initializer = InitializerOrFinalizer('hma.test.test_runner.non_callable')
        self.assertRaises(InitializerOrFinalizerError, initializer)
    ...
    def test_crash(self):
        ...
        """
        initializer = InitializerOrFinalizer('hma.test.test_runner._crashy')
        self.assertRaises(InitializerOrFinalizerError, initializer)
