...
from fetchdata.output import Colors, fetchdataStream
from fetchdata.result import fetchdataTestResult, proto_test, \
...
class TestProtoTest(unittest.TestCase):
    ...
    def test_ProtoTestFromTest(self):
        ...
        """
        module      = 'fetchdata.test.test_result'
        class_name  = 'Small'
        docstr_part = 'stuff'
...
class TestfetchdataTestResult(unittest.TestCase):
    ...
    @patch('fetchdata.result.fetchdataTestResult.printErrors')
    ...
    def test_reportOutcomeCursorUp(self):
        ...
        gs.isatty = isatty
        gtr = fetchdataTestResult(self.args, gs)
        r = 'a fake reason'
        t = MagicMock()
...
class TestfetchdataTestResultAdds(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.args = copy.deepcopy(default_args)
        self.args.verbose = 0
        self.gtr = fetchdataTestResult(self.args, fetchdataStream(self.stream))
